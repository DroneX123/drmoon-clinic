                        ...
                        <div className="p-6 md:p-8 pt-4 border-t border-white/5 bg-slate-950/50">
                            ...
                            <div className="flex gap-3">
                                ...
                                <button
                                    ...
                                    className={`py-4 bg-gradient-to-r from-gold to-amber-400 md:hover:from-white md:hover:to-white text-slate-900 font-bold rounded-xl transition-all shadow-[0_4px_20px_rgba(212,175,55,0.3)] md:hover:shadow-[0_4px_30px_rgba(255,255,255,0.5)] flex items-center justify-center gap-2 uppercase tracking-widest text-sm transform md:hover:-translate-y-1 ${step > 1 ? 'flex-1' : 'w-full'}`}
                                >
